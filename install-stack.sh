...
echo ""
echo "Aternatively, you should now be able to use the ollama cli run/pull your own models as normal i.e: 'ollama run llama3.2' or 'ollama pull llama3.2' etc, to make this alias permanent you can add:"
echo ""
