...
echo ""
echo "Aternatively, you should now be able to use the ollama cli run/pull your own models as normal i.e: 'ollama pull llama3.2' or 'ollama run llama3.2 --verbose' etc, to make this alias permanent you can add:"
echo ""
