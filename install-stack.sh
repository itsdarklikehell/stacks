...
echo ""
echo "Aternatively, you should now be able to use the ollama cli manage/pull/rm your own models as normal i.e: 'ollama pull llama3.2', to make this alias permanent you can add:"
echo ""
