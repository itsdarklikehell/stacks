...
URLS=(
	...
	"http://${IP_ADDRESS}:3003"       # Tv Simulator
	"http://${IP_ADDRESS}:3579"       # Ombi
	"https://${IP_ADDRESS}:3923"      # CopyParty
	"http://${IP_ADDRESS}:4200"       # sycntube
	...
	"http://${IP_ADDRESS}:8680/admin" # owncast admin panel
	"http://${IP_ADDRESS}:9091"       # transmission
	"http://${IP_ADDRESS}:9696"       # prowlarr
)
