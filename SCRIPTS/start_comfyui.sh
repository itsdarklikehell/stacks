...
function LINK_FOLDERS() {
	...
	function ANYTHINGLLM_MODELS() {
		...
		# ## anythingllm_models > anythingllm_models
	...
	function COMFYUI_MODELS() {
		...
		## comfyui_models > anythingllm_models
